# Research Inventory — Master Overview

**Last updated:** 2026-08-11  
**Purpose:** Single-page snapshot of research program state. Update after each research session.

---

## How to use this file

- Counts below must reflect **actual entries** in the linked inventory files — do not invent numbers
- Placeholder seed content (14 demo tools, 8 categories, etc.) is **not** counted as researched inventory
- See `docs/AI_FINDER_RESEARCH_BIBLE.md` for methodology
...
## Placeholder seed content (NOT research)

*Exists only to demo application structure — do not count as researched.*

| Entity | Seed count | Location |
|---|---|---|
| Demo tools | 14 | `lib/data/tools/*.ts` |
| Demo categories | 8 | `lib/data/seedData.ts` |
| Demo personas | 8 | `lib/data/seedData.ts` |
| Demo comparisons | 3 | `lib/data/seedData.ts` |

Full slug lists: Research Bible §18.
...
| [OPPORTUNITIES.md](./OPPORTUNITIES.md) | Future opportunities |
| [REJECTED.md](./REJECTED.md) | Rejected ideas |
...
See [CHANGELOG.md](./CHANGELOG.md) for dated research session entries.
