...
export const PM_TOOLS: Tool[] = [
  ...
  pmTool({
    ...
    tagline: 'Built-in AI status reports from pasted updates with RAG status, blockers, and next-week plans.',
    description:
      'Onplana converts pasted Slack, meeting, or ticket updates into structured executive status reports with RAG status, blockers, and next-week plans. Verified from onplana.com official tool page.',
  ...
  pmTool({
    ...
    cons: ['No structured PM status-report schema on official pages; no permanent free plan — trial available'],
    targetUsers: ['project-managers', 'real-estate-agents'],
  }),
  pmTool({
    name: 'ClickUp Brain',
...
export const PM_TOOL_USE_CASES: PmToolUseCaseSeed[] = [
  ...
  { toolSlug: 'onplana-status-report-writer', useCaseSlug: 'project-reporting', fitTier: 'primary', capabilities: 'Built-in AI status reports from pasted updates with RAG status', limitation: 'Free paste-only tool', evidenceUrl: 'https://onplana.com/tools/status-report-writer', displayOrder: 3 },
  { toolSlug: 'gamma', useCaseSlug: 'project-reporting', fitTier: 'partial', capabilities: 'AI presentations and docs export', limitation: 'General deck builder — no PM status schema; PPTX exports may need cleanup', evidenceUrl: 'https://gamma.app/pricing', displayOrder: 4 },
  { toolSlug: 'beautiful-ai', useCaseSlug: 'project-reporting', fitTier: 'partial', capabilities: 'AI presentations, Reports templates', limitation: 'No structured status report generator; no permanent free plan — trial available', evidenceUrl: 'https://www.beautiful.ai', displayOrder: 5 },
  ...
  { toolSlug: 'motion', useCaseSlug: 'task-management', fitTier: 'primary', capabilities: 'AI Task Planner, auto-prioritization', limitation: 'No free plan — trial available', evidenceUrl: 'https://www.usemotion.com', displayOrder: 4, section: 'task' },
  ...
  { toolSlug: 'motion', useCaseSlug: 'task-management', fitTier: 'primary', capabilities: 'AI Project Manager — generate full projects', limitation: 'No free plan — trial available', evidenceUrl: 'https://www.usemotion.com', displayOrder: 102, section: 'planning' },
