...
export const chatgptTool: Tool = {
  ...
  pros: ['GPT-4o and o1 models for writing, coding, and analysis per OpenAI docs', 'Extensive third-party GPT ecosystem', 'Fast real-time responses', 'Native mobile applications'],
