...
export const midjourneyTool: Tool = {
  ...
  tagline: 'State-of-the-art generative AI image synthesis platform for photorealistic art and design.',
  ...
  pros: ['Unmatched aesthetic output quality', 'Extremely realistic textures and lighting', 'Active community showcase gallery'],
