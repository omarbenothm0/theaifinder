...
export const HOMEPAGE_FEATURED_SECTION_SUBTITLE =
  'Editorially selected listings — user ratings shown where approved reviews exist';

export const HOMEPAGE_FEATURED_TAB_LABEL = 'Featured';

export const HOMEPAGE_FAQ_UPDATE_CADENCE =
  'Listings are reviewed on a rolling basis; check each tool profile for its last-verified date.';
