...
import { Star, CheckCircle2, ArrowRight, Code, Smartphone, Puzzle } from 'lucide-react';
import { ToolOutboundLink } from '../tool/ToolOutboundLink';
...
export function HomeToolCard({ tool }: HomeToolCardProps) {
  return (
    <div className="home-card group flex flex-col justify-between overflow-hidden relative p-5 md:p-6 h-full">
      {tool.featured && (
