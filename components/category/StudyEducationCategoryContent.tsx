  ...
  return (
    <div className="space-y-10">
      ...
      <div className="max-w-4xl mx-auto flex flex-wrap gap-3">
        <Link
          href="/for/students"
          className="inline-flex items-center gap-1.5 text-xs font-bold text-foreground bg-foreground/5 border border-border/50 px-3 py-2 rounded-xl hover:bg-foreground/5 transition-colors"
        >
