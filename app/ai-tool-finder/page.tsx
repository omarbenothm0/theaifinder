  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-10">
      <section className="bg-slate-50 border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-4">
        <h2 className="text-lg font-bold text-slate-900">How the AI Tool Finder works</h2>
        ...
        <p className="text-xs text-slate-500">
          ...
          <Link href="/ai-tools" className="text-emerald-700 font-semibold hover:underline inline-flex items-center gap-1">
            Search the full catalog <ArrowRight className="w-3 h-3" />
          </Link>
          {' '}or explore{' '}
          <Link href="/ai-tools-directory" className="text-emerald-700 font-semibold hover:underline">
            categories by topic
          </Link>.
        </p>
      </section>
